...
async function BalanceCard() {
  ...
  return (
    <Card className="bg-gradient-to-br fromprimary/10 via-primary/5 to-background border-primary/20 shadow-lg flex justify-between flex-col overflow-hidden">
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          View your transaction hsitroy and download invoices
        </CardDescription>
      </CardHeader>
